...
void Processor::get_data_() {
    ...
    if (filestream.is_open()) {
        ...
        linestream >> key >> user_ >> nice_ >> system_ >> idle_ >> iowait_ >> irq_ >>
...
float Processor::Utilization() {
    ...
    auto prevNonIdle = user - guest + nice - guest_nice + system + irq + softirq + steal;
    auto currentNonIdle = user_ - guest_ + nice_ -guest_nice_ + system_ + irq_ + softirq_ + steal_;
